...
<header>
  ...
  <!-- Navigation -->
  <nav style="display:flex;" id="navigation_bar" class="navbar navbar-default">
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <li><a href="carbot.php">My bot</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="carbot.php">Car Bot</a></li>
	...
	{
    ?>
     <div style="margin-top:20px;" class="login_btn"> <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login / Register</a> </div>
    <?php }
    else{
