...
<!-- Start Switcher -->
<!-- <?php include('includes/colorswitcher.php');?> --><!-- /Switcher -->  
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/profile_icon.png" alt="image">
      </div>
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="fullname" value="<?php echo "Welcome " ,  htmlentities($result->FullName);?>" id="fullname" type="text"  required>
            </div>
            <div class="form-group">
